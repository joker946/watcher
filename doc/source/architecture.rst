...
Audit and period (in case of CONTINUOUS type). There is two types of Audit:
...
action plans every 'period' seconds; if action plan has been created,
all previous action plans get CANCELLED state.
